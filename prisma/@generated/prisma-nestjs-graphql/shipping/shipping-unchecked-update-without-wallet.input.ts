...
import { OrderUncheckedUpdateManyWithoutShippingInput } from '../order/order-unchecked-update-many-without-shipping.input';

@InputType()
export class ShippingUncheckedUpdateWithoutWalletInput {
    ...
    @Field(() => OrderUncheckedUpdateManyWithoutShippingInput, {nullable:true})
