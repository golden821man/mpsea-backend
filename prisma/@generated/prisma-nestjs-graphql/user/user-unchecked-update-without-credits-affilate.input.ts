...
import { InstallmentUncheckedUpdateManyWithoutUserInput } from '../installment/installment-unchecked-update-many-without-user.input';
...
@InputType()
export class UserUncheckedUpdateWithoutCreditsAffilateInput {
    ...
    @Field(() => InstallmentUncheckedUpdateManyWithoutUserInput, {nullable:true})
