...
import { InstallmentUncheckedCreateNestedManyWithoutUserInput } from '../installment/installment-unchecked-create-nested-many-without-user.input';
...
@InputType()
export class UserUncheckedCreateWithoutOrdersAffiliateInput {
    ...
    @Field(() => InstallmentUncheckedCreateNestedManyWithoutUserInput, {nullable:true})
