...
import { ActivityUpdateManyWithoutUserInput } from '../activity/activity-update-many-without-user.input';
...
@InputType()
export class UserUpdateWithoutCreditsAffilateInput {
    ...
    @Field(() => ActivityUpdateManyWithoutUserInput, {nullable:true})
