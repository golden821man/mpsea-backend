...
import { CreditRequestUpdateOneWithoutCreditConfigurationInput } from '../credit-request/credit-request-update-one-without-credit-configuration.input';

@InputType()
export class CreditConfigurationUpdateWithoutAttachedWalletsInput {
    ...
    @Field(() => CreditRequestUpdateOneWithoutCreditConfigurationInput, {nullable:true})
