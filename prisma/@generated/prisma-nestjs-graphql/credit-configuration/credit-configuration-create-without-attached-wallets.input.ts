...
import { CreditRequestCreateNestedOneWithoutCreditConfigurationInput } from '../credit-request/credit-request-create-nested-one-without-credit-configuration.input';

@InputType()
export class CreditConfigurationCreateWithoutAttachedWalletsInput {
    ...
    @Field(() => CreditRequestCreateNestedOneWithoutCreditConfigurationInput, {nullable:true})
