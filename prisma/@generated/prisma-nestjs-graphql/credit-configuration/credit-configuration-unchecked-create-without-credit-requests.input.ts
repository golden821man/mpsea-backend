...
import { CreditConfigurationsWalletsUncheckedCreateNestedManyWithoutConfigurationInput } from '../credit-configurations-wallets/credit-configurations-wallets-unchecked-create-nested-many-without-configuration.input';
...
@InputType()
export class CreditConfigurationUncheckedCreateWithoutCreditRequestsInput {
    ...
    @Field(() => CreditConfigurationsWalletsUncheckedCreateNestedManyWithoutConfigurationInput, {nullable:true})
