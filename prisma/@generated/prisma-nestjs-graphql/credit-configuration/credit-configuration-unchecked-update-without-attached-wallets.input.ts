...
import { InstallmentUncheckedUpdateManyWithoutCreditConfigurationInput } from '../installment/installment-unchecked-update-many-without-credit-configuration.input';
...
@InputType()
export class CreditConfigurationUncheckedUpdateWithoutAttachedWalletsInput {
    ...
    @Field(() => InstallmentUncheckedUpdateManyWithoutCreditConfigurationInput, {nullable:true})
