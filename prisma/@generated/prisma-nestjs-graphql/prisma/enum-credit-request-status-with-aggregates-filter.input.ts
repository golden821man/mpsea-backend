...
import { NestedEnumCreditRequestStatusWithAggregatesFilter } from './nested-enum-credit-request-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumCreditRequestStatusFilter } from './nested-enum-credit-request-status-filter.input';

@InputType()
export class EnumCreditRequestStatusWithAggregatesFilter {
