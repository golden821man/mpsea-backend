...
import { NestedEnumSlicesEnumWithAggregatesFilter } from './nested-enum-slices-enum-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumSlicesEnumFilter } from './nested-enum-slices-enum-filter.input';

@InputType()
export class EnumSlicesEnumWithAggregatesFilter {
