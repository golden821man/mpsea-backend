...
import { NestedEnumlegalStatusEnumNullableWithAggregatesFilter } from './nested-enumlegal-status-enum-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumlegalStatusEnumNullableFilter } from './nested-enumlegal-status-enum-nullable-filter.input';

@InputType()
export class EnumlegalStatusEnumNullableWithAggregatesFilter {
