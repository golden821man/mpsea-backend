...
import { NestedEnumcreditRefTypeNullableWithAggregatesFilter } from './nested-enumcredit-ref-type-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumcreditRefTypeNullableFilter } from './nested-enumcredit-ref-type-nullable-filter.input';

@InputType()
export class EnumcreditRefTypeNullableWithAggregatesFilter {
