...
import { NestedEnumEcommercePlatformEnumNullableWithAggregatesFilter } from './nested-enum-ecommerce-platform-enum-nullable-with-aggregates-filter.input';
...
@InputType()
export class EnumEcommercePlatformEnumNullableWithAggregatesFilter {
