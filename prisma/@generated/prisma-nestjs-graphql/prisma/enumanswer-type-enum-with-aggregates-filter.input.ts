...
import { NestedEnumanswerTypeEnumWithAggregatesFilter } from './nested-enumanswer-type-enum-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumanswerTypeEnumFilter } from './nested-enumanswer-type-enum-filter.input';

@InputType()
export class EnumanswerTypeEnumWithAggregatesFilter {
