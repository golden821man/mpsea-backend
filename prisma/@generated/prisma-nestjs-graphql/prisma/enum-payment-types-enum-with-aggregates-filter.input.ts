...
import { NestedEnumPaymentTypesEnumWithAggregatesFilter } from './nested-enum-payment-types-enum-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumPaymentTypesEnumFilter } from './nested-enum-payment-types-enum-filter.input';

@InputType()
export class EnumPaymentTypesEnumWithAggregatesFilter {
