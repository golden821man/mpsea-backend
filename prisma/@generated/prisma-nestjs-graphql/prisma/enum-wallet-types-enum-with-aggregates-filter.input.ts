...
import { NestedEnumWalletTypesEnumWithAggregatesFilter } from './nested-enum-wallet-types-enum-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumWalletTypesEnumFilter } from './nested-enum-wallet-types-enum-filter.input';

@InputType()
export class EnumWalletTypesEnumWithAggregatesFilter {
