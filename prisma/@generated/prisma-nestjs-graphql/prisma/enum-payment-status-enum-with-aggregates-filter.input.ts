...
import { NestedEnumPaymentStatusEnumWithAggregatesFilter } from './nested-enum-payment-status-enum-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumPaymentStatusEnumFilter } from './nested-enum-payment-status-enum-filter.input';

@InputType()
export class EnumPaymentStatusEnumWithAggregatesFilter {
