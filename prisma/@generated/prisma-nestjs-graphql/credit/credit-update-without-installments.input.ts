...
import { CreditConfigurationUpdateOneRequiredWithoutCreditInput } from '../credit-configuration/credit-configuration-update-one-required-without-credit.input';
...
@InputType()
export class CreditUpdateWithoutInstallmentsInput {
    ...
    @Field(() => CreditConfigurationUpdateOneRequiredWithoutCreditInput, {nullable:true})
