...
import { InstallmentUncheckedCreateNestedManyWithoutCreditInput } from '../installment/installment-unchecked-create-nested-many-without-credit.input';

@InputType()
export class CreditUncheckedCreateWithoutCreditConfigurationInput {
