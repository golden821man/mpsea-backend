...
import { InstallmentUncheckedUpdateManyWithoutCreditInput } from '../installment/installment-unchecked-update-many-without-credit.input';

@InputType()
export class CreditUncheckedUpdateWithoutCreditConfigurationInput {
