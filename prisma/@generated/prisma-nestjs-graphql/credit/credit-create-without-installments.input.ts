...
import { CreditConfigurationCreateNestedOneWithoutCreditInput } from '../credit-configuration/credit-configuration-create-nested-one-without-credit.input';
...
@InputType()
export class CreditCreateWithoutInstallmentsInput {
    ...
    @Field(() => CreditConfigurationCreateNestedOneWithoutCreditInput, {nullable:false})
