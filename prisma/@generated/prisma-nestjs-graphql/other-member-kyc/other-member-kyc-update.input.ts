...
import { UserUpdateOneRequiredWithoutOtherMemberKYCInput } from '../user/user-update-one-required-without-other-member-kyc.input';

@InputType()
export class OtherMemberKYCUpdateInput {
    ...
    @Field(() => UserUpdateOneRequiredWithoutOtherMemberKYCInput, {nullable:true})
