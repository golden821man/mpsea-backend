...
import { UserCreateNestedOneWithoutOtherMemberKYCInput } from '../user/user-create-nested-one-without-other-member-kyc.input';

@InputType()
export class OtherMemberKYCCreateInput {
    ...
    @Field(() => UserCreateNestedOneWithoutOtherMemberKYCInput, {nullable:false})
