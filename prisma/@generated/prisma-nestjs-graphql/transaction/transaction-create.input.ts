...
import { WalletCreateNestedOneWithoutTransactionInput } from '../wallet/wallet-create-nested-one-without-transaction.input';
...
export class TransactionCreateInput {
    ...
    @Field(() => WalletCreateNestedOneWithoutTransactionInput, {nullable:true})
