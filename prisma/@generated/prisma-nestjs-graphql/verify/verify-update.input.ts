...
import { UserUpdateOneWithoutVerifyInput } from '../user/user-update-one-without-verify.input';

@InputType()
export class VerifyUpdateInput {
    ...
    @Field(() => UserUpdateOneWithoutVerifyInput, {nullable:true})
