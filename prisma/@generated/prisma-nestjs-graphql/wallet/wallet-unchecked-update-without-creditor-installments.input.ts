...
import { VisitUncheckedUpdateManyWithoutWalletInput } from '../visit/visit-unchecked-update-many-without-wallet.input';
...
@InputType()
export class WalletUncheckedUpdateWithoutCreditorInstallmentsInput {
    ...
    @Field(() => VisitUncheckedUpdateManyWithoutWalletInput, {nullable:true})
