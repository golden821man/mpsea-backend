...
import { OrderCreateNestedManyWithoutVendorWalletInput } from '../order/order-create-nested-many-without-vendor-wallet.input';
...
@InputType()
export class WalletCreateWithoutCreditorInstallmentsInput {
    ...
    @Field(() => OrderCreateNestedManyWithoutVendorWalletInput, {nullable:true})
