...
import { BillingUncheckedCreateNestedManyWithoutWalletInput } from '../billing/billing-unchecked-create-nested-many-without-wallet.input';
...
@InputType()
export class WalletUncheckedCreateWithoutCreditorInstallmentsInput {
    ...
    @Field(() => BillingUncheckedCreateNestedManyWithoutWalletInput, {nullable:true})
