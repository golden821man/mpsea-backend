...
import { InstallmentUpdateManyWithoutCreditorInput } from '../installment/installment-update-many-without-creditor.input';
...
@InputType()
export class WalletUpdateWithoutCreditConfigurationsInput {
    ...
    @Field(() => InstallmentUpdateManyWithoutCreditorInput, {nullable:true})
