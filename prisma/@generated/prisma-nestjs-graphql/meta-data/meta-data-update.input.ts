...
import { WalletUpdateOneRequiredWithoutMetaDataInput } from '../wallet/wallet-update-one-required-without-meta-data.input';
...
export class MetaDataUpdateInput {
    ...
    @Field(() => WalletUpdateOneRequiredWithoutMetaDataInput, {nullable:true})
