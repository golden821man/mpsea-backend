...
import { WalletCreateNestedOneWithoutMetaDataInput } from '../wallet/wallet-create-nested-one-without-meta-data.input';
...
export class MetaDataCreateInput {
    ...
    @Field(() => WalletCreateNestedOneWithoutMetaDataInput, {nullable:false})
