...
import { BillingUpdateOneWithoutOrderInput } from '../billing/billing-update-one-without-order.input';
...
@InputType()
export class OrderUpdateWithoutCreditRequestInput {
    ...
    @Field(() => BillingUpdateOneWithoutOrderInput, {nullable:true})
