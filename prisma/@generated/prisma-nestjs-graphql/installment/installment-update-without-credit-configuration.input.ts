...
import { OrderUpdateOneWithoutInstallmentsInput } from '../order/order-update-one-without-installments.input';
import { UserUpdateOneWithoutInstallmentInput } from '../user/user-update-one-without-installment.input';

@InputType()
export class InstallmentUpdateWithoutCreditConfigurationInput {
    ...
    @Field(() => OrderUpdateOneWithoutInstallmentsInput, {nullable:true})
